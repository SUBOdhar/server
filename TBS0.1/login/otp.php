...
<body>
  ...
  <section>
    ...
    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
      <div id='inputs'>
        <input name="in1" id='input1' type='number' maxLength="1" />
        <input name="in2" id='input2' type='number' maxLength="1" />
        <input name="in3" id='input3' type='number' maxLength="1" />
        <input name="in4" id='input4' type='number' maxLength="1" />
      </div>  
