...
<body>
  ...
  <section>
    ...
    <form action="check.php" method="post">
      ...
      <input name="username" type="text" value="<?php echo $usr; ?>" style="visibility:hidden;">
      <input name="password" type="text" value="<?php echo $pass; ?>" style="visibility:hidden;">
      <input name="otp" type="text" value="<?php echo $output; ?>" style="visibility:hidden;">
      <div id='inputs'>
        <input name="in1" id='input1' type='number' maxLength="1" autocomplete="one-time-code" />
        <input name="in2" id='input2' type='number' maxLength="1" autocomplete="one-time-code" />
        <input name="in3" id='input3' type='number' maxLength="1" autocomplete="one-time-code" />
        <input name="in4" id='input4' type='number' maxLength="1" autocomplete="one-time-code" />
      </div>
